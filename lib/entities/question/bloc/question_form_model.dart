...
class QuestionInput extends FormzInput<String, QuestionValidationError> {
...
class OptionalInput extends FormzInput<bool, OptionalValidationError> {
  const OptionalInput.pure() : super.pure(false);
  const OptionalInput.dirty([bool value = false]) : super.dirty(value);

  @override
  OptionalValidationError validator(bool value) {
    return null;
  }
}
