...
class DocumentTypeInput extends FormzInput<ClientDocumentType, DocumentTypeValidationError> {
  const DocumentTypeInput.pure() : super.pure(ClientDocumentType.POLICY);
  const DocumentTypeInput.dirty([ClientDocumentType value]) : super.dirty(value);

  @override
  DocumentTypeValidationError validator(ClientDocumentType value) {
    return null;
  }
}
